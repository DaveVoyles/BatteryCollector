...
public:
	 ...
	 * @param PowerChange This is the amount to change the power by, and it can be + or -
	 */
...
protected:
	...
	/** Multiplier for char speed */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Power", Meta = (BlueprintProtected = "true"))
	float SpeedFactor;

	/** Speed when char's power level is 0 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Power", Meta = (BlueprintProtected = "true"))
	float BaseSpeed;

	/** BlueprintImplementableEvent: Do not define the function in call at all. Just acll it, and let the blueprints
	 * Handle the behavior behind it. */
